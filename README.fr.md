...
| `pii_detection_superclinical`     | PII et dé-identification | NAME, DATE, SSN, PHONE, EMAIL, ADDRESS | 434M |
...
Extraction et dé-identification en `en`, `fr`, `de`, `it`, `es`, `nl`, `hi`, `te`, `pt`, `ar`, `ja` et `tr` — **247 checkpoints PII** au total.
