...
An optional, user-configured Indic NER family accepts one additional route
(`ml`) and can also serve Assamese, Bengali, Gujarati, Hindi, Kannada,
Marathi, Odia, Punjabi, Tamil, and Telugu. Set `OPENMED_INDIC_NER_MODEL`; OpenMed never
