...
`am`, `ar`, `cs`, `da`, `de`, `el`, `en`, `es`, `fr`, `gu`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `no`, `pt`, `ro`, `ru`, `sv`, `sw`, `te`, `th`, `tr`, `uk`, `xh`, `zh` और `zu`, कुल **600+ PII checkpoints** के साथ।
...
(`as`, `bn`, `kn`, `ml`, `mr`, `or`, `pa` और `ta`) स्वीकार करती है और Gujarati,
