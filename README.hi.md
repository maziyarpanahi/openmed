...
<p>
  <b>2,000+ मॉडल</b> &nbsp;·&nbsp; <b>21 मॉडल-समर्थित PII भाषाएँ</b> &nbsp;·&nbsp; <b>600+ PII चेकपॉइंट</b> &nbsp;·&nbsp; <b>100% डिवाइस पर</b> &nbsp;·&nbsp; <b>Apache-2.0</b>
</p>
...
| मॉडल-समर्थित PII भाषाएँ               |            21            |            भिन्न            |
| ऑफ़लाइन / एयर-गैप्ड                   |            ✅            |             ❌              |
...
## बहुभाषी PII (22 समर्थित भाषाएँ)

निष्कर्षण और डी-आइडेंटिफिकेशन **22 समर्थित PII भाषा codes** में उपलब्ध हैं:
`am`, `ar`, `de`, `en`, `es`, `fr`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `pt`, `ro`, `sw`, `te`, `th`, `tr`, `xh`, `zh` और `zu`, कुल **600+ PII checkpoints** के साथ।
...
| [v1 से v2 migration](docs/migration.md) | [MCP client connections](docs/mcp-clients.md) | |
