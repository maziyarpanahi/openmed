...
## बहुभाषी PII (39 समर्थित रूट; 35 मॉडल-समर्थित)

निष्कर्षण और डी-आइडेंटिफिकेशन **39 समर्थित PII भाषा codes** में उपलब्ध हैं:
`am`, `ar`, `as`, `bn`, `cs`, `da`, `de`, `el`, `en`, `es`, `fa`, `fr`, `gu`, `he`, `hi`, `id`, `it`, `ja`, `kn`, `ko`, `mr`, `nl`, `no`, `or`, `pa`, `pt`, `ro`, `ru`, `sv`, `sw`, `ta`, `te`, `th`, `tr`, `uk`, `vi`, `xh`, `zh` और `zu`, कुल **रजिस्ट्री-आधारित PII मॉडल कैटलॉग** के साथ।
...
एक वैकल्पिक, उपयोगकर्ता द्वारा configured Indic NER family एक अतिरिक्त route
(`ml`) स्वीकार करती है और Assamese, Bengali, Gujarati, Hindi, Kannada,
Marathi, Odia, Punjabi, Tamil तथा Telugu को भी सेवा दे सकती है। `OPENMED_INDIC_NER_MODEL` सेट करें; OpenMed इन
