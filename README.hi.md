...
<p>
  <b>2,000+ मॉडल</b> &nbsp;·&nbsp; <b>27 मॉडल-समर्थित PII भाषाएँ</b> &nbsp;·&nbsp; <b>600+ PII चेकपॉइंट</b> &nbsp;·&nbsp; <b>100% डिवाइस पर</b> &nbsp;·&nbsp; <b>Apache-2.0</b>
</p>
...
| मॉडल-समर्थित PII भाषाएँ               |            27            |            भिन्न            |
| ऑफ़लाइन / एयर-गैप्ड                   |            ✅            |             ❌              |
...
`am`, `ar`, `cs`, `da`, `de`, `el`, `en`, `es`, `fr`, `he`, `hi`, `id`, `it`, `ja`, `ko`, `nl`, `no`, `pa`, `pt`, `ro`, `ru`, `sv`, `sw`, `te`, `th`, `tr`, `uk`, `xh`, `zh` और `zu`, कुल **600+ PII checkpoints** के साथ।
...
एक वैकल्पिक, उपयोगकर्ता द्वारा configured Indic NER family आठ अतिरिक्त routes
(`as`, `bn`, `gu`, `kn`, `ml`, `mr`, `or` और `ta`) स्वीकार करती है और Hindi,
Punjabi तथा Telugu को भी सेवा दे सकती है। `OPENMED_INDIC_NER_MODEL` सेट करें;
OpenMed इन weights को न तो bundle करता है और न अपने आप चुनता है।
