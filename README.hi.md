...
<p>
  <b>2,266 मैनिफ़ेस्ट प्रविष्टियाँ</b> &nbsp;·&nbsp; <b>36 मॉडल-समर्थित PII भाषाएँ</b> &nbsp;·&nbsp; <b>Apache-2.0 SDK</b>
</p>
...
## बहुभाषी PII (39 समर्थित रूट; 36 मॉडल-समर्थित)

निष्कर्षण और डी-आइडेंटिफिकेशन **39 समर्थित PII भाषा codes** में उपलब्ध हैं:
`am`, `ar`, `as`, `bn`, `cs`, `da`, `de`, `el`, `en`, `es`, `fa`, `fr`, `gu`, `he`, `hi`, `id`, `it`, `ja`, `kn`, `ko`, `mr`, `nl`, `no`, `or`, `pl`, `pt`, `ro`, `ru`, `sv`, `sw`, `ta`, `te`, `th`, `tr`, `uk`, `vi`, `xh`, `zh` और `zu`, कुल **रजिस्ट्री-आधारित PII मॉडल कैटलॉग** के साथ।
