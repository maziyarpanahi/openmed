...
फिर immutable OpenMed `v2.1.0` release उपयोग करें:
...
| [OpenMed 2.1.0 release notes](docs/release/v2.1.0.md) | [OpenMed 2.0.0 release notes](docs/release/v2.0.0.md) | [उदाहरण](docs/examples.md) |
