...
| `OpenMed/privacy-filter-multilingual` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pt, ro, sv, sw, te, th, tr, uk, ur, xh, zu | - | pytorch |
| `OpenMed/privacy-filter-multilingual-mlx` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pt, ro, sv, sw, te, th, tr, uk, ur, xh, zu | - | mlx-fp, pytorch |
| `OpenMed/privacy-filter-multilingual-mlx-8bit` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pt, ro, sv, sw, te, th, tr, uk, ur, xh, zu | - | mlx-8bit, pytorch |
| `OpenMed/privacy-filter-multilingual-v2` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pt, ro, sv, sw, te, th, tr, uk, ur, xh, zu | - | pytorch |
