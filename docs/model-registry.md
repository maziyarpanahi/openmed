...
The committed manifest contains 2,266 entries across 36 model-backed PII languages. Family counts: General=9, NER=1,093, PII=1,018, Vision=3, ZeroShot=143.
...
| `OpenMed/privacy-filter-multilingual` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pl, pt, ro, sv, sw, te, th, tr, uk, xh, zu | - | pytorch |
| `OpenMed/privacy-filter-multilingual-mlx` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pl, pt, ro, sv, sw, te, th, tr, uk, xh, zu | - | mlx-fp, pytorch |
| `OpenMed/privacy-filter-multilingual-mlx-8bit` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pl, pt, ro, sv, sw, te, th, tr, uk, xh, zu | - | mlx-8bit, pytorch |
| `OpenMed/privacy-filter-multilingual-v2` | PII | token-classification | am, ar, as, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, kn, mr, nl, no, or, pl, pt, ro, sv, sw, te, th, tr, uk, xh, zu | - | pytorch |
