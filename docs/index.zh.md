...
OpenMed `2.3.0` 为 Python、Swift、Kotlin/Android、JavaScript、REST 和本地部署界面延续稳定的 v2 契约，并整合策略感知的去标识化、扩展的临床与结构化数据工作流、广泛的多语言 PII 覆盖以及失败即关闭的发布证据：
...
- [OpenMed 2.3.0 发布说明](/docs/release/v2.3.0/) — 当前安装坐标、兼容性指南、平台覆盖范围和验证要求。
...
3. [OpenMed 2.3.0 发布说明](/docs/release/v2.3.0/) — 查看当前安装坐标、兼容性契约和验证要求。
4. 核心指南：
