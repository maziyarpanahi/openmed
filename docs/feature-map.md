...
| Markup and metadata | HTML/HTM, Markdown/AsciiDoc, and EPUB extraction; HTML source-offset redaction; DOCX offset extraction; source text redaction; image/PDF/DOCX metadata scrubbing; and residual metadata verification. | `openmed/multimodal/documents_html.py`, `openmed/multimodal/documents_docx.py`, `openmed/multimodal/epub.py`, `openmed/multimodal/metadata_scrub.py`, `examples/v17_multimodal_browser_interop.py` |
