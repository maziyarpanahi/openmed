...
- **31 supported PII language codes: am, ar, cs, da, de, el, en, es, fr, he, hi,
  id, it, ja, ko, mr, nl, no, pt, ro, ru, sv, sw, ta, te, th, tr, uk, xh, zh,
  and
  zu**,
  with Russian
  and Chinese using documented multilingual default-model placeholders, locale-aware validation and surrogate
  generation. A user-configured Indic NER adapter adds seven optional routes
  and can also serve Hindi, Marathi, Tamil, and Telugu. Additional
  validator-backed national-ID
