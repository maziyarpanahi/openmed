...
- **30 supported PII language codes: am, ar, cs, da, de, el, en, es, fr, he, hi,
  id, it, ja, ko, nl, no, pa, pt, ro, ru, sv, sw, te, th, tr, uk, xh, zh, and zu**,
  with Russian
  and Chinese using documented multilingual default-model placeholders, locale-aware validation and surrogate
  generation. A user-configured Indic NER adapter adds eight optional routes and
  can also serve Hindi, Punjabi, and Telugu. Additional validator-backed national-ID
