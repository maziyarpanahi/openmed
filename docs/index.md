...
OpenMed `2.5.0` extends the stable v2 contract across Python, Swift,
...
- **39 supported PII language codes: am, ar, as, bn, cs, da, de, el, en, es, fa, fr, gu,
  he, hi, id, it, ja, kn, ko, ml, mr, nl, no, or, pt, ro, ru, sv, sw, ta, te, th, tr,
  ...
  Indic NER adapter adds one optional route and can also serve Assamese,
  Bengali, Gujarati, Hindi, Kannada, Malayalam, Marathi, Odia, Tamil, and Telugu. Additional validator-backed national-ID
...
- [OpenMed 2.5.0 Release Notes](./release/v2.5.0.md) – current installation coordinates, compatibility guidance, platform coverage, and qualification requirements.
...
3. [OpenMed 2.5.0 Release Notes](./release/v2.5.0.md) – review the current installation coordinates, compatibility contract, and validation requirements.
4. Core guides:
