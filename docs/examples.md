...
| `examples/browser_transformersjs_demo/` | Static browser demo that runs Transformers.js token classification and deterministic synthetic PII matching without a backend. |
