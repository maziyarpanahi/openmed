...
nl, no, pa, pt, ro, ru, sv, sw, te, th, tr, uk, xh, zh, and zu**. Russian and
...
`gu`, `kn`, `ml`, `mr`, `or`, and `ta`. Those codes require an explicit model
or `OPENMED_INDIC_NER_MODEL`; Hindi, Punjabi, and Telugu can use the adapter too.
