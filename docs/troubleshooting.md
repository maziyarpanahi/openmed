...
mr, nl, no, pt, ro, ru, sv, sw, te, th, tr, uk, xh, zh, and zu**. Russian and
...
`gu`, `kn`, `ml`, `or`, `pa`, and `ta`. Those codes require an explicit model
or `OPENMED_INDIC_NER_MODEL`; Hindi, Marathi, and Telugu can use the adapter too.
