...
nl, no, pt, ro, ru, sv, sw, ta, te, th, tr, uk, xh, zh, and zu**. Russian and
...
`gu`, `kn`, `ml`, `mr`, `or`, and `pa`. Those codes require an explicit model
or `OPENMED_INDIC_NER_MODEL`; Hindi, Tamil, and Telugu can use the adapter too.
