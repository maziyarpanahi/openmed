...
language codes: am, ar, cs, da, de, el, en, es, fr, gu, he, hi, id, it, ja, ko,
...
`kn`, `ml`, `mr`, `or`, `pa`, and `ta`. Those codes require an explicit
model or `OPENMED_INDIC_NER_MODEL`; Gujarati, Hindi, and Telugu can use the
adapter too.
