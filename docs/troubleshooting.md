...
```text
ValueError: Unsupported language 'xx'. Supported: ['ar', 'de', 'en', 'es', 'fr', 'he', 'hi', 'id', 'it', 'ja', 'ko', 'nl', 'pt', 'ro', 'sw', 'te', 'th', 'tr', 'zh']
```

**Cause.** PII extraction and de-identification support **19 supported PII language codes: ar, de, en, es,
fr, he, hi, id, it, ja, ko, nl, pt, ro, sw, te, th, tr, and zh**. Chinese currently uses the documented
