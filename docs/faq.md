...
PII extraction and de-identification support **14 supported PII language codes**:
`ar`, `de`, `en`, `es`, `fr`, `hi`, `id`, `it`, `ja`, `nl`, `pt`, `te`, `th`, and `tr`.
The README keeps a short multilingual example set in
[Multilingual PII](https://github.com/maziyarpanahi/openmed#multilingual-pii-14-languages).
