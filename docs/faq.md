...
PII extraction and de-identification support **21 supported PII language codes**:
...
[Multilingual PII](https://github.com/maziyarpanahi/openmed#multilingual-pii-21-supported-languages).
