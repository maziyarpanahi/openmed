...
One additional Indic code (`pa`)
is an opt-in route through a user-configured `OPENMED_INDIC_NER_MODEL`;
Assamese, Bengali, Gujarati, Hindi, Kannada, Malayalam, Marathi, Odia, Tamil, and Telugu can use
the same adapter.
