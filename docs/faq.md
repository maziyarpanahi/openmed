...
PII extraction and de-identification support **25 supported PII language codes**:
...
[Multilingual PII](https://github.com/maziyarpanahi/openmed#multilingual-pii-25-supported-languages).
