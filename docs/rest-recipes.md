...
selects the recommended PII model for `lang`. The 37 supported PII language
codes: `am`, `ar`, `as`, `bn`, `cs`, `da`, `de`, `el`, `en`, `es`, `fa`, `fr`, `he`, `hi`,
`id`, `it`, `ja`, `kn`, `ko`, `mr`, `nl`, `no`, `or`, `pt`, `ro`, `ru`, `sv`, `sw`,
`ta`, `te`, `th`, `tr`, `uk`, `vi`, `xh`, `zh`, and `zu`. Russian currently uses a
documented multilingual default-model placeholder. The API also accepts three
optional Indic routes (`gu`, `ml`, and `pa`) when
