...
codes: `am`, `ar`, `as`, `cs`, `da`, `de`, `el`, `en`, `es`, `fr`, `he`,
`hi`, `id`, `it`, `ja`, `ko`, `nl`, `no`, `pt`, `ro`, `ru`, `sv`, `sw`, `te`,
...
optional Indic routes (`bn`, `gu`, `kn`, `ml`, `mr`, `or`, `pa`, and `ta`) when
`OPENMED_INDIC_NER_MODEL` or an explicit model is configured; Assamese, Hindi,
