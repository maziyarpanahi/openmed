...
Users building mobile apps can now validate Python-to-Android span equivalence,
exercise model download/cache behavior, and prepare AAR publishing through the
guarded Central Portal workflow.
