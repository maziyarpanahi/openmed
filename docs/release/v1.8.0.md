...
Reviewed range: `v1.7.0..70529b59`.
...
- Reviewed head: `70529b5995496e0983a488980b9e42ab36aa338b`
- Local range reviewed: `v1.7.0..HEAD`
- Total commits reviewed: 432
- Merge commits reviewed: 223
- Non-merge commits reviewed: 209
- First-parent commits reviewed: 77
- First-parent merge commits reviewed: 41
- Unique PR links in GitHub generated notes for `v1.7.0...v1.8.0`: 144
- Aggregate diff reviewed: 631 files changed, 114,970 insertions, 1,396 deletions
...
- GitHub release-note generation was checked with `tag_name=v1.8.0`, `previous_tag_name=v1.7.0`, and target `70529b59`.
