...
Reviewed range: `v1.7.0..e9e0c39b`.
...
- Added release and supply-chain hardening: trusted publishing, SLSA provenance, image signing, container SBOMs, vulnerability gates, baseline-aware secret scanning, pre-commit scanning, and reproducible release metadata.
...
- Reviewed head: `e9e0c39bbff8fa6bf3806de136b26b24d8ce8db1`
- Local range reviewed: `v1.7.0..HEAD`
- Total commits reviewed: 410
- Merge commits reviewed: 223
- Non-merge commits reviewed: 187
- First-parent commits reviewed: 55
- First-parent merge commits reviewed: 41
- Unique PR links in GitHub generated notes for `v1.7.0...v1.8.0`: 144
- Aggregate diff reviewed: 622 files changed, 114,707 insertions, 1,366 deletions
...
- GitHub release-note generation was checked with `tag_name=v1.8.0`, `previous_tag_name=v1.7.0`, and target `e9e0c39b`.
