...
- Added Android OpenMedKit: Gradle project setup, Kotlin API, span merger, BIO/BIOES decoder, ONNX and ORT Mobile inference, ML Kit OCR, model catalog/download cache, document/image intake, Compose and scan demos, Android CI, parity fixtures, GitHub-tag installation through JitPack, and optional guarded Maven Central publishing.
...
Users building mobile apps can install the AAR from immutable GitHub tags through
JitPack, validate Python-to-Android span equivalence, exercise model
download/cache behavior, and prepare optional AAR publishing through the guarded
