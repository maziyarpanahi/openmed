...
<img src="docs/brand/openmed-mascot-lockup.png" alt="OpenMed — పరికరంలో నడిచే క్లినికల్ AI · 1,500+ మోడల్‌లు" width="400" />
...
<p>
  <b>1,500+ మోడల్‌లు</b> &nbsp;·&nbsp; <b>15 PII భాషలు</b> &nbsp;·&nbsp; <b>600+ PII చెక్‌పాయింట్‌లు</b> &nbsp;·&nbsp; <b>100% పరికరంలో</b> &nbsp;·&nbsp; <b>Apache-2.0</b>
</p>
...
```mermaid
flowchart LR
    A["క్లినికల్ టెక్స్ట్"] --> B["OpenMed<br/>(100% పరికరంలో)"]
    B --> C["వైద్య ఎంటిటీలు"]
...
<a href="https://star-history.com/#maziyarpanahi/openmed&Date">
  <img src="https://api.star-history.com/svg?repos=maziyarpanahi/openmed&type=Date" alt="స్టార్ చరిత్ర చార్ట్" width="640" />
</a>
