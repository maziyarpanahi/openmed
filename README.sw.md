...
<p>
  <b>Modeli 2,000+</b> &nbsp;·&nbsp; <b>Lugha 28 za PII zinazotumia modeli</b> &nbsp;·&nbsp; <b>Checkpoint 600+ za PII</b> &nbsp;·&nbsp; <b>100% kwenye kifaa</b> &nbsp;·&nbsp; <b>Apache-2.0</b>
</p>
...
| Lugha za PII zinazotumia modeli      |              28                | Hutofautiana              |
...
`am`, `ar`, `cs`, `da`, `de`, `el`, `en`, `es`, `fr`, `gu`, `he`, `hi`, `id`, `it`,
...
iliyosanidiwa na mtumiaji hukubali njia nane za ziada (`as`, `bn`, `kn`, `ml`,
`mr`, `or`, `pa` na `ta`) na inaweza pia kuhudumia Kigujarati, Kihindi na Kitelugu.
