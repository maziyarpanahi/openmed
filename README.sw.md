...
`ja`, `ko`, `ml`, `nl`, `no`, `pt`, `ro`, `ru`, `sv`, `sw`, `te`, `th`, `tr`,
...
iliyosanidiwa na mtumiaji hukubali njia nane za ziada (`as`, `bn`, `gu`, `kn`,
`mr`, `or`, `pa` na `ta`) na inaweza pia kuhudumia Kihindi, Kimalayalam na
Kitelugu.
