...
`ja`, `kn`, `ko`, `nl`, `no`, `pt`, `ro`, `ru`, `sv`, `sw`, `te`, `th`, `tr`,
...
iliyosanidiwa na mtumiaji hukubali njia nane za ziada (`as`, `bn`, `gu`, `ml`,
`mr`, `or`, `pa` na `ta`) na inaweza pia kuhudumia Kihindi, Kikannada na Kitelugu.
