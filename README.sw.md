...
`ja`, `kn`, `ko`, `mr`, `nl`, `no`, `or`, `pa`, `pt`, `ro`, `ru`, `sv`, `sw`, `ta`, `te`,
...
iliyosanidiwa na mtumiaji hukubali njia moja ya ziada (`ml`) na inaweza pia kuhudumia Kiassam, Kibengali, Kigujarati, Kihindi, Kikannada, Kimarathi, Kiodia, Kipunjabi, Kitamil na Kitelugu.
