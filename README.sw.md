...
Kisha tumia toleo lisilobadilika la OpenMed `v2.3.0`:
...
| [Maelezo ya Toleo la OpenMed 2.3.0](docs/release/v2.3.0.md) | [Maelezo ya Toleo la OpenMed 2.2.0](docs/release/v2.2.0.md) | [Mifano](docs/examples.md) |
